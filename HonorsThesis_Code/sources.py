...
#File- Contents: this file contains all the methods used to find the appropriate sites based on the customers response
import openai
...
class sources:
    ...
    def get_sources(self, message_body): # Create a message, run the assistant on it, monitor it for completion, and display the output
        ...
        while run.status != "completed":
            ...
            if run.status == "failed":
                return "No sources could be found"
